...
def set_indent(indent_size):
    """Set the indentation directly """
    global INDENT
    INDENT = indent_size
...
def describe(module, start_indent=INDENT):
    """ Describe the module object passed as argument
    including its classes and functions """

    set_indent(start_indent)
...
def describe_from_string(module_name, start_indent=INDENT):
    """Describe the module object represented by the string argument """
    mod = __import__(module_name, fromlist="dummy")
    describe(mod, start_indent)
